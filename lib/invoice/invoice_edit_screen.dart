...
class InvoiceEditScreen extends ConsumerStatefulWidget {
  ...
  const InvoiceEditScreen({Key? key, this.extra}) : super(key: key);

  @override
  InvoiceEditScreenState createState() => InvoiceEditScreenState();
}

class InvoiceEditScreenState extends ConsumerState<InvoiceEditScreen> {
  ...
  void _onEditPressed() {
    ...
    if (_formKey.currentState != null &&
      ...
      ref.read(invoiceUseCaseProvider).editInvoice(editedInvoice).then((value) {
